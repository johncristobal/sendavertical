...
<!--<![endif]-->
	<head>
		...
		<title>Editar Perfil | Senda Vertical</title>
																...
																<div class="cmsms_contact_form">
																				<div class="cmsms-form-builder">
																								...
																								<form id="updateUsuario">
																									...
																									<input type="hidden" value="<?=$this->session->userdata('idUser')?>" name= "idUser" id="idUser">
																									<input type="hidden" value="<?=$this->session->userdata('tipoUsuario')?>" name= "tipoUser" id="tipoUser">
																												<div class="form_info cmsms_input">
																																<label for="contact_name_2">Nombre:<span class="color_2">*</span></label>
																																<div class="form_field_wrap">
																																				<input type="text" name="nombre" id="nombre" value="<?= $this->session->userdata('nombre')?>" size="35" class="validate[required]" />
																																</div>
																												</div>
																												<div class="form_info cmsms_input">
																																<label for="contact_name_2">Fecha de Nacimiento:<span class="color_2">*</span></label>
																																<div class="form_field_wrap">
																																				<input type="date" name="nacimiento" id="nacimiento" value="<?= $this->session->userdata('nacimiento')?>"  class="validate[required]" />
																																</div>
																												</div>														
																												<div class="form_info cmsms_input">
																																<label for="contact_name_2">Correo:<span class="color_2">*</span></label>
																																<div class="form_field_wrap">
																																				<input type="email" name="correo" id="correo" value="<?= $this->session->userdata('correo')?>" size="35" class="validate[required]" />
																																</div>
																												</div>
																												<div class="form_info cmsms_input one_half">
																																<label for="contact_name_2">Elija una constraseña:<span class="color_2">*</span></label>
																																<div class="form_field_wrap">
																																				<input type="password" name="pass1" id="pass1" value="" size="35" class="validate[required]" />
																																</div>
																												</div>
																												<div class="form_info cmsms_input one_half">
																																<label for="contact_name_2">Repita la constraseña:<span class="color_2">*</span></label>
																																<div class="form_field_wrap">
																																				<input type="password" name="pass2" id="pass2" value="" size="35" class="validate[required]" />
																																</div>
																												</div>																
																												<div class="cl"></div>
