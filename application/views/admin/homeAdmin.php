													...
													<li id="cmsms_icon_list_item_553e49e81f676" class="cmsms_icon_list_item">
														<div class="cmsms_icon_list_item_inner">
															<div class="cmsms_icon_list_icon_wrap">
																<a href="<?= base_url();?>admin/usuarios"><span class="cmsms_icon_list_icon cmsms-icon-user-7"></span></a>
															</div>
															<div class="cmsms_icon_list_item_content">
																<h2 class="cmsms_icon_list_item_title">Administrar Usuarios</h2>
																 <div class="cmsms_icon_list_item_text">
																	<p>Usuarios supervisores y administradores que tienen acceso al sistema.</p>
																</div> 
															</div>
														</div>
													</li>
											...
											<div class="cmsms_column one_half">
												<ul id="cmsms_icon_list_items_553e49e81f520" class="cmsms_icon_list_items cmsms_icon_list_type_block cmsms_icon_list_pos_left cmsms_color_type_icon">
													<li id="cmsms_icon_list_item_553e49e81f676" class="cmsms_icon_list_item">
														<div class="cmsms_icon_list_item_inner">
															<div class="cmsms_icon_list_icon_wrap">
															 <a href="<?= base_url();?>admin/reportes"><span class="cmsms_icon_list_icon cmsms-icon-edit-3"></span></a>
																
															</div>
															<div class="cmsms_icon_list_item_content">
																<h2 class="cmsms_icon_list_item_title">Reportes</h2>
																<div class="cmsms_icon_list_item_text">
																	<p>Revisa los reportes que llevan a cabo los supervisores.</p>
																</div>
															</div>
														</div>
													</li>
													<li id="cmsms_icon_list_item_553e49e81f7b9" class="cmsms_icon_list_item">
														<div class="cmsms_icon_list_item_inner">
															<div class="cmsms_icon_list_icon_wrap">
															 <a href="<?= base_url();?>admin/editarPerfil"><span class="cmsms_icon_list_icon cmsms-icon-edit-3"></span></a>
