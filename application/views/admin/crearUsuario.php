...
<!--<![endif]-->
	<head>
		...
		<title>Crear Usuario | Senda Vertical</title>
						...
						<div id="cmsms_row_9" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									...
									<h1 class="cmsms_post_title entry-title">Crear Usuario</h1>
									<br>
														...
														<form id="crearUsuario">
															<div class="form_info cmsms_input">
																...
																<div class="form_field_wrap">
																	<input type="text" name="nombre" id="nombre" value="" size="35" class="validate[required]" />
																</div>
															</div>
															<div class="form_info cmsms_input">
																<label for="contact_name_2">Fecha de Nacimiento:<span class="color_2">*</span></label>
																<div class="form_field_wrap">
																	<input type="date" name="nacimiento" id="nacimiento" value=""  class="validate[required]" />
																</div>
															</div>
															...
															<div class="form_info cmsms_input">
																...
																<div class="form_field_wrap">
																	<input type="text" name="correo" id="correo" value="" size="35" class="validate[required]" />
																</div>
															</div>
															...
															<input type="submit" name="enviar" class="cmsms_button" value="Crear Usuario">
...
<!-- _________________________ Finish Page _________________________ -->
	<!--	<script type='text/javascript' src='js/jsLibraries.min.js'></script>
		...
		<script type='text/javascript' src='js/jqueryLibraries.min.js'></script> -->
                    ...
                    $("#crearUsuario").on("submit",function(){
                       event.preventDefault();
                       $.ajax({
                           url: "<?=base_url()?>Admin/crearUsuario",
                           data: $("#crearUsuario").serialize(),
                           type: "post",
                           success: function(res){
                               if(res == "Se ha registrado el nuevo usuario con éxito"){
                                   alert(res);
