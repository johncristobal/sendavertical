														...
														<div class="cmsms_row_inner">
															<div class="cmsms_row_margin">
																<div class="cmsms_column one_first">
																	<figure>
																		<img src="img/images/bear-population-open.jpg" alt="Bear Population" title="Bear Population" class="<full-width></full-width>">
																	</figure>
																	<div class="cmsms_text">
																		<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique. At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique. At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique.At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique. At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique. At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate similique.</p>
																	</div>
																</div>
															</div>
														</div>
									...
									<aside class="share_posts">
										...
										<div class="fl share_posts_item">
											<a href="#" class="pin-it-button">
												<img src="img/images/PinExt.png" title="Pin It" alt="" />
											</a>
											<script type="text/javascript">
												(function (d, s, id) { 
													var js = undefined, 
											...
											<div class="ovh">
												...
												<div class="social_wrap">
													<div class="social_wrap_inner">
														<ul>
															<li><a href="mailto:example@example.com" class="cmsms-icon-mail-6" title="Email" target="_blank"></a></li>
														</ul>
													</div>
												</div>
											</div>
