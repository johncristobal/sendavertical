...
<!--<![endif]-->
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
                ...
                <meta name="description" content="impulsar el interés y la conciencia social colectiva respecto al desarrollo de la vida y evolución de los seres vivos en el planeta" />
                <meta name="author" content="senda vertical" />
                <meta name="keywords" content="arboricultura, conciencia, vida, planeta, senda, vertical" />

		<title>Servicios TREPA| Senda Vertical </title>
										...
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<div id="cmsms_divider_55533402efbb2" class="cmsms_divider"></div>
                                                                                                <h3 id="cmsms_heading_55544abfb9eef" class="cmsms_heading cmsms_valid_title">Trepa recreativa</h3>
												<h6 id="cmsms_heading_5554579e9193d" class="cmsms_heading">En un esfuerzo por concientizar a la sociedad hemos creado un programa de
trepa de árboles recreativa, la cual busca impulsar el interés y la conciencia social colectiva respecto al
desarrollo de la vida y evolución de los seres vivos en el planeta. Conocer sobre los procesos biológicos
básicos de los árboles como la respiración, transpiración y fotosíntesis; todo a través de un enfoque
divertido, complementando con aplicaciones prácticas y actividad física en la copa de los árboles. Esta
actividad es recomendable para talleres escolares o eventos especiales.</h6>
											</div>
										</div>
									</div>
								</div>
													...
													<ul class="cmsms_hover_slider_items">
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="<?= base_url();?>img/galeria/imagen1.jpeg" class="attachment-post-thumbnail" alt="leaves" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="<?= base_url();?>img/images/forest-medium.jpg" class="attachment-post-thumbnail" alt="forest" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="<?= base_url();?>img/images/ozon-medium.jpg" class="attachment-post-thumbnail" alt="ozon" />
															</figure>
														</li>
													</ul>
												</div>
