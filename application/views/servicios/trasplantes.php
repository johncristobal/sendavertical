...
<!--<![endif]-->
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
                ...
                <meta name="description" content="Es responsabilidad de nosotros identificar las ventajas y desventajas de trasplantar un árbol." />
                <meta name="author" content="senda vertical" />
                <meta name="keywords" content="arboricultura, identificar, trasplantar, arbol, senda, vertical" />

		<title>Servicios TRASPLANTES| Senda Vertical </title>
										...
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<div id="cmsms_divider_55533402efbb2" class="cmsms_divider"></div>	
                                                                                                <h3 id="cmsms_heading_55544abfb9eef" class="cmsms_heading cmsms_valid_title">Trasplantes</h3>
												<h6 id="cmsms_heading_5554579e9193d" class="cmsms_heading">Como profesionales de los arboles buscaremos la opción más viable, es
responsabilidad de nosotros identificar las ventajas y desventajas de trasplantar un árbol, realizaremos un
análisis evaluando los riesgos para tomar la mejor decisión para el individuo, eso también implica que en
ocasiones no sea lo más recomendable.
