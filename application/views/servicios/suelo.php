...
<!--<![endif]-->
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
                ...
                <meta name="description" content="para promover una salud integral del individuo se analizara la estructura física y química del suelo para determinar las mejoras a realizar." />
                <meta name="author" content="senda vertical" />
                <meta name="keywords" content="arboricultura, salud, fisica, suelo, senda, vertical" />

		<title>Servicios SUELO| Senda Vertical </title>
	...
	<!--_________________________ Start Content _________________________ -->
						...
						<div class="cmsms_breadcrumbs_inner align_right">
							...
							<span class="breadcrumbs_sep"> / </span>
							<span>Descompactación y mejoramiento de suelo</span>
						</div>
					</div>
								...
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin cmsms_11">
											<div class="cmsms_column one_first">
												<h2 id="cmsms_heading_555343bed6f13" class="cmsms_heading">Descompactación y mejoramiento de suelo</h2>
													...
													<ul class="cmsms_hover_slider_items">
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="" height="490" src="<?= base_url();?>img/servicios/suelo/IMG_6661.png" class="attachment-post-thumbnail" alt="leaves" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="" height="490" src="<?= base_url();?>img/servicios/suelo/IMG_6651.png" class="attachment-post-thumbnail" alt="forest" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
