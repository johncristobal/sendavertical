...
<!--<![endif]-->
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
                ...
                <meta name="description" content="El ambiente urbano puede crear mucho estrés para los arboles, haciéndolos más vulnerables ante el ataque de plagas" />
                <meta name="author" content="senda vertical" />
                <meta name="keywords" content="arboricultura, plagas, urbano, arboles, servicios, senda, vertical" />

		<title>Servicio PLAGAS| Senda Vertical </title>
	...
	<!--_________________________ Start Content _________________________ -->
						...
						<div class="cmsms_breadcrumbs_inner align_right">
							...
							<span class="breadcrumbs_sep"> / </span>
							<span>Diagnóstico y tratamiento de plagas</span>
						</div>
					</div>
									...
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column ">
												...
												<h3 id="cmsms_heading_55544abfb9eef" class="cmsms_heading cmsms_valid_title">Diagnóstico y tratamiento de plagas</h3>
                                                                                                <h6 id="cmsms_heading_5554579e9193d" class="cmsms_heading">El ambiente urbano puede crear mucho estrés para los
                                                                                                arboles, haciéndolos más vulnerables ante el ataque de plagas. Preferimos en general el uso de
                                                                                                tratamientos con productos orgánicos. Cuando la situación requiere de un tratamiento más drástico,
                                                                                                utilizamos equipo de endoterapia (inyecciones directas al sistema vascular de los árboles) para
                                                                                                asegurarnos de no contaminar o poner en riesgo el Medio.</h6>
											</div>
										</div>
									</div>
								</div>
						...
						<div id="cmsms_row_55533402efcad" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div align= "center" class="cmsms_column one_seventh">
