...
<!--<![endif]-->
	<head>
		...
		<title>Galería | Senda Vertical </title>
		...
		<style type="text/css">
			...
			#cmsms_row_5554657d81044 .cmsms_row_outer_parent{ 
				...
				padding-bottom: 50px; 
                        ...
                        .headline_outer {
                            background-image: url(img/tierra2.png);
                            background-repeat: repeat;
                            background-attachment: fixed;
                            background-size: cover;
                        }
					...
					<div class="headline cmsms_color_scheme_first">
						<div class="headline_outer">
							...
							<div class="headline_inner align_center">
								<div class="headline_aligner"></div><div class="headline_text headline_subtitle"><h1 class="entry-title">Galería</h1></div>
							</div>
						</div>
					</div>
	...
	<!--_________________________ Start Content _________________________ -->
									...
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 class="cmsms_heading align_left cmsms_valid_title">Galleries</h3>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<!--h2 id="cmsms_heading_55533402e9d9b" class="cmsms_heading">Thumbnails Gallery</h2-->
												<div class="cmsms_gallery">
													<ul>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen1.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen1.jpeg" class="attachment-medium" alt="life" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen2.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen2.jpeg" class="attachment-medium" alt="loneliness" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen3.jpeg.jpg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen3.jpeg" class="attachment-medium" alt="white-tiger-1" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen6.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen6.jpeg" class="attachment-medium" alt="ocean-1" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen4.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen4.jpeg" class="attachment-medium" alt="Biodiversity" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen5.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen5.jpeg" class="attachment-medium" alt="Biodiversity-1" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen7.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen7.jpeg" class="attachment-medium" alt="Biodiversity-2" />
																</a>
															</figure>
														</li>
														<li class="one_fourth">
															<figure>
																<a href="img/galeria/imagen8.jpeg" rel="ilightbox[55533402e9e65]">
																	<img width="300" height="238" src="img/galeria/imagen8.jpeg" class="attachment-medium" alt="Ozon" />
																</a>
															</figure>
														</li>
													</ul>
							...
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<div id="cmsms_divider_55533402efbb2" class="cmsms_divider solid"></div>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_half">
												<h2 id="cmsms_heading_55533402efefb" class="cmsms_heading">Eventos</h2>
												<script type="text/javascript">
													jQuery(document).ready(function (){ 
														jQuery("#cmsms_hover_slider_55533402effa4").cmsmsHoverSlider({ 
															sliderBlock : "#cmsms_hover_slider_55533402effa4", 
													...
													<ul class="cmsms_hover_slider_items">
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="img/galeria/imagen1.jpeg" class="attachment-post-thumbnail" alt="leaves" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="img/images/forest-medium.jpg" class="attachment-post-thumbnail" alt="forest" />
															</figure>
														</li>
														<li>
															<figure class="cmsms_hover_slider_full_img">
																<img width="820" height="490" src="img/images/ozon-medium.jpg" class="attachment-post-thumbnail" alt="ozon" />
															</figure>
														</li>
													</ul>
												</div>
											...
											<div class="cmsms_column one_half">
												<h2 id="cmsms_heading_55533402f170d" class="cmsms_heading">Trepa</h2>
												<div class="content_slider_wrap" style="max-width:px;">
													<script type="text/javascript">
														jQuery(document).ready(function (){ 
															jQuery("#cmsms_slider_55533402f17ca.content_slider").owlCarousel({ 
																singleItem : true, 
													...
													<div id="cmsms_slider_55533402f17ca" class="content_slider owl-carousel">
														<div class="item">
															<img width="820" height="651" src="img/galeria/imagen1.jpeg" class="attachment-full" alt="ocean-3" />
														</div>
														<div class="item">
															<img width="820" height="651" src="img/galeria/imagen2.jpeg" class="attachment-full" alt="present" />
														</div>
														<div class="item">
															<img width="820" height="651" src="img/galeria/imagen3.jpeg" class="attachment-full" alt="loneliness" />
														</div>
														<div class="item">
															<img width="820" height="651" src="img/galeria/imagen4.jpeg" class="attachment-full" alt="life" />
														</div>
													</div>
												</div>
											</div>
						...
						<!--div id="cmsms_row_title_2" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 class="cmsms_heading align_left cmsms_valid_title">Progress Counters</h3>
											</div>
										</div>
									</div>
								</div>
						...
						<div id="cmsms_row_5552f7fc00cb1" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_5552f7fc00f25" class="cmsms_heading cmsms_valid_title">KEEP TRACK OF THE NATURE SAVING PROGRESS</h3>
											</div>
										</div>
									</div>
								</div>
						...
						<div id="cmsms_row_555212697abbb" class="cmsms_row cmsms_color_scheme_fifth">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<div class="cmsms_stats stats_mode_counters stats_type_circles stats_noborder" data-animation="fadeInUp" data-delay="0"><div class="cmsms_stat_wrap one_fourth">
													<div id="cmsms_stat_555212697b83f" class="cmsms_stat stat_has_titleicon" data-percent="77" data-bar-color="#57cbe1">
														...
														<div id="cmsms_stat_555212697b8db" class="cmsms_stat stat_has_titleicon" data-percent="83" data-bar-color="#62e0c1">
														...
														<div id="cmsms_stat_555212697b971" class="cmsms_stat stat_has_titleicon" data-percent="92" data-bar-color="#7fe092">
														...
														<div id="cmsms_stat_555212697ba05" class="cmsms_stat stat_has_titleicon" data-percent="95" data-bar-color="#b7f275">
						...
						<div id="cmsms_row_555212697bbe6" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_5552f7fc020f4" class="cmsms_heading cmsms_valid_title">LOCAL CLIMATE SUMMARY</h3>
												<div class="cmsms_stats stats_mode_counters stats_type_numbers stats_noborder" data-animation="fadeInUp" data-delay="0"><div class="cmsms_stat_wrap one_third">
														<div id="cmsms_stat_555212697c017" class="cmsms_stat stat_has_titleicon" data-percent="23">
														...
														<div id="cmsms_stat_555212697c0b2" class="cmsms_stat stat_has_titleicon" data-percent="38">
														...
														<div id="cmsms_stat_555212697c14e" class="cmsms_stat stat_has_titleicon" data-percent="187">
						...
						<div id="cmsms_row_555212697c32b" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<div class="cmsms_stats stats_mode_bars stats_type_circles stats_noborder"><div class="cmsms_stat_wrap">
													<div id="cmsms_stat_555212697c641" class="cmsms_stat" data-percent="88">
														...
														<div id="cmsms_stat_555212697c6e2" class="cmsms_stat" data-percent="68">
															<div class="cmsms_stat_inner">
																<span class="cmsms_stat_title">Recycling</span>
																<span class="cmsms_stat_counter_wrap">
														...
														<div id="cmsms_stat_555212697c76c" class="cmsms_stat" data-percent="84">
															<div class="cmsms_stat_inner">
														...
														<div id="cmsms_stat_555212697c7f2" class="cmsms_stat" data-percent="75">
															<div class="cmsms_stat_inner">
														...
														<div id="cmsms_stat_555212697c875" class="cmsms_stat" data-percent="77">
															<div class="cmsms_stat_inner">
						...
						<div id="cmsms_row_title_3" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 class="cmsms_heading align_left cmsms_valid_title">Clients</h3>
											</div>
										</div>
									</div>
								</div>
						...
						<div id="cmsms_row_55544abfb78d1" class="cmsms_row cmsms_color_scheme_default" data-stellar-background-ratio="0.5">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_55544abfb8187" class="cmsms_heading cmsms_valid_title">Without Border</h3>
												<script type="text/javascript">
													jQuery(document).ready(function (){ 
												...
												<div class="cmsms_clients_slider_wrap">
													<div id="cmsms_clients_55544abfb8253" class="cmsms_clients_slider owl-carousel clients_noborder">
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_NewGate_dark.png" alt="NewGate" title="NewGate" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_BigFish_dark.png" alt="Big Fish" title="Big Fish" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_Increase_dark.png" alt="Increase" title="Increase" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_halsey_dark.png" alt="Halsey" title="Halsey" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_Shepard_dark.png" alt="Shepard" title="Shepard" />
															</a>
														</div>
													</div>
												</div>
						...
						<div id="cmsms_row_55544abfb9cdf" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_55544abfb9eef" class="cmsms_heading cmsms_valid_title">Grid</h3>
												<div class="cmsms_clients_grid_wrap">
													<div id="cmsms_clients_55544abfb9f83" class="cmsms_clients_grid clients_four">
														<div class="cmsms_clients_items slides">
															<div class="cmsms_clients_item item">
																<a href="portfolio.html" target="_blank">
																	<img src="img/images/client_halsey.png" alt="Halsey" title="Halsey" />
																</a>
															</div>
															<div class="cmsms_clients_item item">
																<a href="portfolio.html" target="_blank">
															...
															<div class="cmsms_clients_item item">
																<a href="portfolio.html" target="_blank">
																	<img src="img/images/client_BigFish.png" alt="Big Fish" title="Big Fish" />
																</a>
															</div>
														</div>
													</div>
						...
						<div id="cmsms_row_55544abfbb4dc" class="cmsms_row cmsms_color_scheme_default" data-stellar-background-ratio="0.5">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_55544abfbb9bf" class="cmsms_heading cmsms_valid_title">Slider</h3>
												<script type="text/javascript">
													jQuery(document).ready(function (){ 
														jQuery("#cmsms_clients_55544abfbba60").owlCarousel({ 
															singleItem : false, 
															items : 4, 
															itemsDesktopSmall : [768,2],
															itemsTablet: [540,1], 
												...
												<div class="cmsms_clients_slider_wrap">
													<div id="cmsms_clients_55544abfbba60" class="cmsms_clients_slider owl-carousel">
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
														...
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_clockstone.png" alt="Clockstone" title="Clockstone" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
						...
						<div id="cmsms_row_55544abfbd039" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 id="cmsms_heading_55544abfbd262" class="cmsms_heading cmsms_valid_title">Custom Height</h3>
												<script type="text/javascript">
													jQuery(document).ready(function (){ 
														jQuery("#cmsms_clients_55544abfbd2fc").owlCarousel({ 
															singleItem : false, 
															items : 4, 
															itemsDesktopSmall : [768,2],
															itemsTablet: [540,1], 
												...
												<div class="cmsms_clients_slider_wrap">
													<div id="cmsms_clients_55544abfbd2fc" class="cmsms_clients_slider owl-carousel">
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
																<img src="img/images/client_whiteblack.png" alt="WhiteBlack" title="WhiteBlack" />
															</a>
														</div>
														<div class="cmsms_clients_item item">
															<a href="portfolio.html" target="_blank">
						...
						<div id="cmsms_row_title_14" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												<h3 class="cmsms_heading align_left cmsms_valid_title">Embedded</h3>
											</div>
										</div>
									</div>
								</div>
						...
						<div id="cmsms_row_5554657d7fed1" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											...
											<div class="cmsms_column one_half">
												<h3 id="cmsms_heading_5554657d801f6" class="cmsms_heading cmsms_valid_title">Vimeo</h3>
												<div class="cmsms_embed_wrap">
													<iframe width="640" height="400" src="//player.vimeo.com/video/87656584"></iframe>
												</div>
											</div>
											<div class="cmsms_column one_fourth"></div>
										</div>
						...
						<div id="cmsms_row_5554657d804a3" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_fourth"></div>
											<div class="cmsms_column one_half">
												<div id="cmsms_divider_5554657d806d6" class="cmsms_divider solid"></div>
											</div>
											<div class="cmsms_column one_fourth"></div>
										</div>
									</div>
						...
						<div id="cmsms_row_5554657d80816" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_fourth"></div>
											<div class="cmsms_column one_half">
												<h3 id="cmsms_heading_5554657d80a81" class="cmsms_heading cmsms_valid_title">Youtube</h3>
												<div class="cmsms_embed_wrap">
													<iframe width="640" height="360" src="https://www.youtube.com/embed/xeXGMa6xu7k?wmode=transparent&amp;rel=0"></iframe>
												</div>
											</div>
											<div class="cmsms_column one_fourth"></div>
										</div>
						...
						<div id="cmsms_row_5554657d80ce6" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_fourth"></div>
											<div class="cmsms_column one_half">
												<div id="cmsms_divider_5554657d80f0d" class="cmsms_divider solid"></div>
											</div>
											<div class="cmsms_column one_fourth"></div>
										</div>
									</div>
						...
						<div id="cmsms_row_5554657d81044" class="cmsms_row cmsms_color_scheme_default">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_fourth"></div>
											<div class="cmsms_column one_half">
												<h3 id="cmsms_heading_5554657d812a5" class="cmsms_heading cmsms_valid_title">Soundcloud</h3>
												<div class="cmsms_embed_wrap">
													<iframe width="640" height="400" src="https://w.soundcloud.com/player/?visual=true&amp;url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F136758775&amp;show_artwork=true&amp;maxwidth=640&amp;maxheight=1000"></iframe>
												</div>
											</div>
											<div class="cmsms_column one_fourth"></div>
										</div>
